...
EventEmitter.prototype.emit = function (a) {
    ...
    if (Array.isArray(b)) {
        let c = Array.prototype.slice.call(arguments, 1), d = b.slice();
        for (let e = 0, f = d.length; e < f; e++) d[e].apply(this, c);
        return !0
    }
    return !1
}
...
EventEmitter.prototype.removeListener = function (a, b) {
    ...
    let c = this._events[a];
    if (Array.isArray(c)) {
        let d = -1;
        for (let e = 0, f = c.length; e < f; e++) if (c[e] === b || c[e].listener && c[e].listener === b) {
            d = e;
            break
        }
        if (d < 0) return this;
...
EventEmitter.mixin = function (a) {
    for (let b in EventEmitter.prototype) a.prototype[b] || (a.prototype[b] = EventEmitter.prototype[b])
};